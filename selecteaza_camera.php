			...
			<div class="users">
				<?php  
					...
					if(ISSET($_GET['id_camera'])){
						...
						$query = "SELECT tip FROM camere, tip_camera
						WHERE camere.id_tip_camera= tip_camera.id_tip_camera AND camere.id_camera ='$id_camera'"; 
				...
				<div class="col-md-10">
					<div class="jumbotron">
		        		<div class="w3-content w3-section">
							<?php 
							 	$query = "SELECT poze_camere FROM poze_camera,camere WHERE camere.id_camera=poze_camera.id_camera AND camere.id_camera ='$id_camera'"; 
								$rand = mysqli_query($con,$query);
