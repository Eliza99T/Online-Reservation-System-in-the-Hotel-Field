                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
							<?php
								include("connect.php");
								$query = $con->query( "SELECT * FROM `statiune` ORDER BY id_statiune ASC");
								{
									while ($num = $query->fetch_array(MYSQLI_ASSOC)) { 
										echo"<tr>
											<th>".$num['id_statiune']."</th>
											<th>".$num['nume_statiune']."</th>
											<th><a href = 'stergere_statiuni.php?id_statiune=".$num['id_statiune']." ' class = 'btn btn-danger'> Sterge</a><th>
										</tr>";
									} 
								}
							?>     
